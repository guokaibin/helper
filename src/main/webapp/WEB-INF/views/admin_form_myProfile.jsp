                        ...
                        <div class="am-u-sm-12 am-u-md-9">
                            ...
                            <form class="am-form am-form-horizontal" action="sendUserInfo.do" id="userInfoform" method="post">
                               ...
                               <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-4">
                                        <input type="text" id="user-birthday" placeholder="必填"  name="birthday" value="${userInfo.birthday }" class="am-form-field tpl-form-no-bg" data-am-datepicker=""   readonly/>
                                         <small id="birthdayMsg" style="color:red"></small>
                                    </div>
                                    
                                    <label for="doc-vld-age-2" class="am-u-sm-2 am-form-label">年龄</label>
                                    <div class="am-u-sm-4">
                                        <input type="number" class="" name="age" id="doc-vld-age-2" value="${userInfo.age }" placeholder="必填且年龄 在1-120之间" min="1" max="120" required/>
                                ...
                                <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-4">
                                        <input type="number" id="user-QQ" name="QQ" min="1000" pattern="[1-9]\d{4,}"  value="${userInfo.QQ }"  placeholder="必填且在4位数字-12位数字之间" required>
                                    </div>
                                </div>  
                                ...
                                <div class="am-form-group">
                                    ...
                                    <label  class="am-u-sm-2 am-form-label" >结算</label>
                                    <div class="am-u-sm-4" >
                                    	<div class="row" >
                                    		<div class="am-u-sm-6">
                               ...
                               <div class="am-form-group">
                                    ...
                                    <div class="am-u-sm-10">
                                        <textarea class="" minlength="10" maxlength="250" name="intro" rows="5" id="user-intro" value="${userInfo.intro }" placeholder="250字以内写出你的一生..."></textarea>
                                        <small>非必填</small>
                                    </div>
                               </div>
