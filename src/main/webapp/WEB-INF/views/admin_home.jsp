            ...
            <div class="row">
                <div class="am-u-md-6 am-u-sm-12 row-mb">
                    <div class="tpl-portlet">
                        ...
                        </div>此部分数据请在 js文件夹下中的 app.js 中的 “百度图表A” 处修改数据 插件使用的是 百度echarts
                                            ...
                                            <ul class="tpl-task-list tpl-task-remind">
                                                <li>
                                                    ...
                                                    <div class="cosA">
                                                        ...
                                                        <span> 注意：Chrome 和 Firefox 下， display: inline-block; 或 display: block; 的元素才会应用旋转动画。<span class="tpl-label-info"> 提取文件 <i class="am-icon-share"></i></span></span>
                                                    </div>
                                                </li>
